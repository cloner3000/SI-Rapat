<div id="page-wrapper">
    ...
    <div class="row">
    	...
    	<form name="form1" method="post" action="<?php echo base_url() ?>admin/jadwal_rapat/tambah" class="myform">
    		<p class="col-lg-4">
              ...
              <div class="table-responsive">
                <table class="table table-stripped">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url() ?>admin/jadwal_rapat/edit/<?php echo $list['id_event_rapat'] ?>">EDIT</a>
                        </td>
                    </tr>
                    <?php } ?>
                    </tbody>
