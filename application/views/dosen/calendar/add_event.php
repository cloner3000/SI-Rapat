...
<div style="width:500px; height:135px; overflow:auto; color:#000000; margin-bottom:20px;" align="center">
	...
	<table>
		...
		<!-- <tr>
			...
			<td>:</td>
			<td><?php echo "$h&nbsp;:&nbsp;$m";?>&nbsp;:&nbsp;<select name="second" disabled><option value="00">00</option></select></td>
		</tr> -->
		<tr>
			<td>Event <span class="require">*</span></td>
			<td>:</td>
			<td><input type="text" name="event" id="event" maxlength="50" size="50" /></td>
		</tr>
		<tr>
			<td colspan="2"></td>
			<td>
